...
LinkedList* ll_newLinkedList(void)
{
    ...
    LinkedList* this= (LinkedList*) malloc(sizeof(LinkedList));//pido espacio en memoria
    if(this != NULL)
    {
        this->pFirstNode=NULL;//primer vagon lo inicializo nulo
        this->size=0;
    }
...
{
    int returnAux = -1;
    Node* nuevoNodo=NULL; //creo vagon
    //Node* pPrevNode =NULL;
    if(this !=NULL && nodeIndex >=0 && nodeIndex <=ll_len(this))
    {
        nuevoNodo=(Node*) malloc(sizeof(Node));//pido espacio para el nuevo vagon
        //sie entro es xq lo cree
        if(nuevoNodo!= NULL)
        {
            //cargo el vagon
...
int ll_clear(LinkedList* this)
{
    ...
    if(this !=NULL)
    {
        ...
        }*/while(!(ll_isEmpty(this)>0))
        {
            //mientras el tren tenga vagones,removemos siempre el vagon 0
...
int ll_contains(LinkedList* this, void* pElement)
{
    ...
    {
        returnAux=0;
        if(ll_indexOf(this,pElement)!=-1) //es q lo tiene{
        {
            returnAux=1;
        }
    }
...
/** \brief Devuelve un nuevo LinkedList cargado con los elementos filtrados
 *
 *
 * \param LinkedList* ll_filter LinkedList* LinkedList a filtrar
 *\param (*pFunc)(void*)puntero a la funcion que filtra
 *\return nuevo puntero a LinkedLIst con los elementos que pasamos
 */
